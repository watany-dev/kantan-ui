...
> **✅ 実装完了** (2026-01-12)
>
> Phase 1-2 の基本機能を実装済み。
> - `kt.cache_data()`: シリアライズ可能なデータのキャッシュ
> - `kt.cache_resource()`: シリアライズ不可なリソースのキャッシュ
> - TTL / max_entries / LRU eviction サポート
> - グローバルクリアAPI (`clear_all_caches()`)
